...
### Stage 2. Prioritising needs

I started this stage by prioritising the tasks sales managers perform. Priority 1 went to the core scenarios that take the most time in the current implementation; priority 2 to secondary scenarios, or ones that are quick anyway.
