...
> **Это исторический документ** — запись того, как сайт строился, задача за задачей. После
> завершения работ структура менялась: контент переехал в `content/`, блок `Contacts.astro`
> и метрики в герое убраны. Актуальное устройство описано в `AGENTS.md`, актуальные критерии
> приёмки — в спеке. Здесь всё оставлено как было при исполнении, чтобы не терять контекст
> решений.
